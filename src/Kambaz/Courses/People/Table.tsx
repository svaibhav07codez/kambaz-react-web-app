   ...
   <Table striped>
    ...
    <tbody>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-06-10</td>
      <td className="wd-total-activity">10:21:38</td>
     </tr>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-04-10</td>
      <td className="wd-total-activity">10:10:38</td>
     </tr>
