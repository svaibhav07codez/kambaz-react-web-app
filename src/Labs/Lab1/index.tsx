export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag" style={{ backgroundColor: "white", color: "black" }}>
        <h4>Paragraph Tag</h4>
        <p id="wd-p-1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Make a paste with Suhana powder.</li>
          <li>Make tomato puree.</li>
          <li>In a pan, add oil.</li>
          <li>Add tomato puree and let it sit for a while.</li>
          <li>Cut paneer on the side.</li>
          <li>After a while, add the paste to the tomato puree.</li>
          <li>Mix well.</li>
          <li>Add paneer cubes, salt, and chili powder.</li>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="./images/angular.png" height="200px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
