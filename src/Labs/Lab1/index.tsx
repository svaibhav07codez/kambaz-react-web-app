        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-omelette">
                    ...
                    <li>Pour in the egg mixture and let it set.</li>
                    <li>Add required fillings.</li>
                    <li>Slide onto a plate and enjoy warm!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input placeholder="lrechintala" id="wd-text-fields-username" /> <br />
                    <label htmlFor="wd-text-fields-password">Password:</label>
                    <input type="password" value="123@#$asd" id="wd-text-fields-password" />
                    <br />
                    <label htmlFor="wd-text-fields-first-name">First name:</label>
                    <input type="text" title="Likhith" id="wd-text-fields-first-name" /> <br />
                    <label htmlFor="wd-text-fields-last-name">Last name:</label>
                    <input type="text" placeholder="Rechintala" title="The last name" id="wd-text-fields-last-name" />
                    <h5>Text boxes</h5>
