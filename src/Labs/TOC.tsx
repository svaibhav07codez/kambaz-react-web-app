...
export default function TOC() {
    ...
    return (
        <Nav variant="pills" id="wd-toc">
            ...
            <Nav.Item>
                <Nav.Link href="https://github.com/svaibhav07codez/kambaz-react-web-app/tree/project" target="_blank">Kambaz React App GitHub Repo</Nav.Link>
            </Nav.Item>
            <Nav.Item>
                <Nav.Link href="https://github.com/svaibhav07codez/kambaz-node-server-app/tree/project" target="_blank">Kambaz Server GitHub Repo</Nav.Link>
            </Nav.Item>
        </Nav>
    );
}
